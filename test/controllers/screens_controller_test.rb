...
class ScreensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screen" do
    assert_difference("Screen.count") do
      post screens_url, params: { screen: { image_url: @screen.image_url, title: @screen.title } }
    end
  ...
  test "should update screen" do
    patch screen_url(@screen), params: { screen: { image_url: @screen.image_url, title: @screen.title } }
